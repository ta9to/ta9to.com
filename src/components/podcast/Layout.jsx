...
import posterImage from '@/images/27135243-1659181405482-7ea98c364181.jpeg'
...
function AboutSection(props) {
  ...
  return (
    <section {...props}>
      ...
      >
        毎週土曜日の朝に収録のとある五反田web系ITベンチャー所属の新しいもの好き未来志向webエンジニア安松とその愉快な仲間たち（先輩エンジニア工藤＋HR&amp;PRシンペイワタナベ）3名による『アウトプットはインプットの母』をコンセプトとした新感覚ドタバタweb系情報バラエティ番組。
      </p>
      {!isExpanded && (
        <button
          type="button"
...
export function Layout({ children }) {
  let hosts = ['Takuto Kudo', 'Kairi Yasumatsu']
        ...
        <div className="relative z-10 mx-auto px-4 pb-4 pt-10 sm:px-6 md:max-w-2xl md:px-4 lg:min-h-full lg:flex-auto lg:border-x lg:border-slate-200 lg:py-12 lg:px-8 xl:px-12">
          ...
          <div className="mt-10 text-center lg:mt-12 lg:text-left">
            <p className="text-xl font-bold text-slate-900">
              <Link href="/podcast">Lazy Saturday Morning</Link>
            </p>
            <p className="mt-3 text-lg font-medium leading-8 text-slate-700">
              Just a lazy engineer&apos;s conversation.
            </p>
          </div>
          ...
          <section className="mt-10 lg:mt-12">
            ...
            >
              {[
                ['Spotify', SpotifyIcon, 'https://open.spotify.com/show/2Nmzzui1HnD1FYfHJx5hLd'],
                ['Apple Podcast', ApplePodcastIcon, 'https://podcasts.apple.com/us/podcast/lazy-saturday-morning-webエンジニアによるゆるいテック系お喋り/id1631663739'],
                ['RSS Feed', RSSIcon, 'https://anchor.fm/s/a255aecc/podcast/rss'],
              ].map(([label, Icon, url]) => (
